...
| Evaluation set | `eval_version` | `not-yet-published` | fixtures, expected findings, anchors |
...
- A minor version adds backward-compatible fields, branches, adapters, or checks.
...
- A style-contract change requires prompt-pack and QA impact review.
